        ...
        <div className='container my-5 py-5'>
            <div className="row">
                ...
                <div className="col-md-6 col-12">
                    ...
                    <div className="row">
                        <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <p><span className=" your-email"><input type="email" size="40" className=" form-control" aria-required="true" aria-invalid="false" placeholder="Your Email" /></span> </p>
                        </div>
                        <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <p><input type="submit" value="Send Mail" className="  btn pull-right" /></p>
                </div>
            </div>
